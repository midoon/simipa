<div id="uploadTeacher" class="fixed inset-0 bg-gray-900 bg-opacity-50 hidden">
    <div class="h-full flex items-center justify-center">
        <div class="bg-white rounded-lg w-1/3 p-6">
            <h2 class="text-xl font-semibold text-gray-800 mb-4">Upload Data Guru</h2>
            <!-- Formulir Tambah Data -->
            <form action="/admin/teacher/template/upload" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-5 ">
