...
<div id="editAttendance" class="fixed inset-0 bg-gray-900 bg-opacity-50 z-50 hidden">
    <div class="h-full flex items-center justify-center">
        <div class="bg-white rounded-lg w-10/12 p-4 sm:w-1/2 sm:py-10">
            <h1 class="font-bold text-center mb-5">Edit Presensi</h1>
            <form action="/teacher/attendance/edit" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="flex justify-end mt-3">
                    <button type="button" onclick="closeEditAttendance()"
